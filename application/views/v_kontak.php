			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Aimas, Sorong Papua Barat</li>
						<li><i class="icon-phone"></i><a href="https://api.whatsapp.com/send?phone=6282256330920&text=Halo%20Admin">+6282256330920</a></li>
						<li><i class="icon-envelope"></i><a href="#">suwandiaminsangaji@gmail.com</a></li>
						<li><i class="icon-globe"></i><a href="http://suwandiaminsangaji.000webhostapp.com" target="_blank">http://suwandiaminsangaji.00webhostapp.com</a></li>
					</ul>
				</div>
