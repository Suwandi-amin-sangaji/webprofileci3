...
<html class="no-js">
	...
	<meta name="author" content="suwandi amin sangaji" />
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					...
		   					<p class="fh5co-lead"> Awesome source code by <a href="http://suwandiaminsangaji.000webhostapp.com" target="_blank">suwandi amin snagaji</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
