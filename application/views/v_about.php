...
<html class="no-js"> <!--<![endif]-->
	...
	<link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/images/th.ico'?>">
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">wandy<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Who We Are</h2>
		   					<p class="fh5co-lead"> Awesome source code by <a href="http://suwandiaminsangaji.000webhostapp.com" target="_blank">suwandi amin sangaji</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						<img src="<?php echo base_url().'theme/images/foto.jpg'?>" alt="Free HTML5 Bootstrap Template" class="img-responsive">
						<h3>suwandi amin sangaji</h3>
						<h4>Co-Founder, CEO</h4>
						<p>suwandi amin sangaji adalah seorang senior engineer lulusan perguruan tinggi di daerah sorong papu barat.</p>
					...
					<div class="col-md-4 fh5co-staff">
						<img src="<?php echo base_url().'theme/images/rezky2.jpg'?>" alt="Free HTML5 Bootstrap Template" class="img-responsive" style="">
						<h3>Reski puspita sari</h3>
						<h4>Co-Founder, CTO</h4>
						<p>Reski puspita sari adalah seorang web designer lulusan perguruan tinggi di daerah sorong papua barat.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>anggota e adalah seorang web designer lulusan perguruan tinggi di daerah sorong papua barat.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
